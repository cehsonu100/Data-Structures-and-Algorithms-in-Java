 ...
 *
 *         References https://en.wikipedia.org/wiki/Dijkstra%27s_algorithm CLRS
 *         book
 */
public class DijskastraTR {

    public Map<Vertex<Integer>, Integer> shortestPath(Graph<Integer> graph, Vertex<Integer> sourceVertex) {

        // heap + map data structure
        PriorityQueueMin<Vertex<Integer>> minHeap = new PriorityQueueMin<>();
        ...
        while (!minHeap.empty()) {
            ...
            // from source vertex.
            PriorityQueueMin<Vertex<Integer>>.Node heapNode = minHeap.extractMinNode();
    ...
    public static void main(String args[]) {
        ...
        /*
         * graph.addEdge(0, 1, 4); graph.addEdge(1, 2, 8); graph.addEdge(2, 3, 7);
         * graph.addEdge(3, 4, 9); graph.addEdge(4, 5, 10); graph.addEdge(2, 5, 4);
         * graph.addEdge(1, 7, 11); graph.addEdge(0, 7, 8); graph.addEdge(2, 8, 2);
         * graph.addEdge(3, 5, 14); graph.addEdge(5, 6, 2); graph.addEdge(6, 8, 6);
        ...
        DijskastraTR dsp = new DijskastraTR();
